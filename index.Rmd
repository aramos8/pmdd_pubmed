...
fillRow(height = 300, flex = c(2.5, 1), 
  ...
  plotOutput("keyterm_categories", width = "100%")
)

pubs_year <- renderPlot({
...
fillRow(height = 600, 
  ...
  table <- DT::renderDataTable({   # Explore this to apply filters: https://stackoverflow.com/questions/42742788/r-shiny-filter-for-all-values
    DT::datatable(
      publications %>% 
